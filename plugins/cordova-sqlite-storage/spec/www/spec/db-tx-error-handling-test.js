  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': detailed tx error handling test(s)', function() {
      ...
      describe(scenarioList[i] + ': tx error semantics test(s)', function() {
        ...
        it(suiteName + 'transaction ends with error if success callback throws [TBD (WebKit) Web SQL vs plugin error messages-detail]', function(done) {
        ...
        it(suiteName + 'readTransaction ends with error if success callback throws [TBD (WebKit) Web SQL vs plugin error messages-detail]', function(done) {
